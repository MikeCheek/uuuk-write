    ...
    <Section id="section2" bgColor="bg-redBrick" shapeColor="text-white" preset="left">
      <div className="text-left text-beige">
        <ShowOnView className="flex justify-start">
          <Typography variant="h2" className="font-bold uppercase mr-auto !text-black opacity-80 mb-8" >
            Highly customizable
          </Typography>
          <Typography variant="p" className="text-lg md:text-xl mr-auto ml-0">
            {renderText(t("Hero3Text").split("<br/><br/>")[0])}
          </Typography>
          <ul className="space-y-5 text-beige mt-10 text-lg md:text-xl">
            <li className="flex items-center justify-start">
              <ModuleIconWarm className="w-8 h-8 text-yellow mr-3 flex-shrink-0 mt-1" />
